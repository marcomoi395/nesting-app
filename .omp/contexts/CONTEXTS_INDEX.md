...
| [`multi-seed-quality-runs.md`](multi-seed-quality-runs.md) | Multi-seed Sparrow quality-run selection and tail refinement | Working on nesting quality-run behavior, final-sheet tail refinement, scoring, seed selection, or final result/export wiring | 2026-07-23 (reduced tail seed count) |
