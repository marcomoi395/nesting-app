...
- Multi-seed mode runs each quality seed sequentially, completes full Sparrow solve plus per-seed `last-only` tail refinement, then compares final summaries using unified scoring.
